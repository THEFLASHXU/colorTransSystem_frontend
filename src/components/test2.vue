  ...
  <div class="page">
    <!-- <div class="header">
      ...
      <div class="right">
        ...
        <router-link class="routerlink" to="/create">创作中心</router-link>
        <router-link class="routerlink" to="/history">历史记录</router-link>
    ...
    <div class="content">
      <Index v-if="tabPosition == 'sj'"></Index>
      <Recommend v-if="tabPosition == 'xg'"></Recommend>
      <Matenew v-if="tabPosition == 'pp'"></Matenew>
    </div>
  </div>
</template>
...
import Matenew from "./mateNew.vue";
